    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900">ConstructMax</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <a href="tel:+5511999999999" className="flex items-center space-x-2 text-orange-600 hover:text-orange-700 transition-colors">
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200">
              <div className="flex flex-col space-y-4">
                ...
                <a href="#depoimentos" className="text-gray-700 hover:text-orange-600 transition-colors font-medium">Depoimentos</a>
                <a href="#contato" className="text-gray-700 hover:text-orange-600 transition-colors font-medium">Contato</a>
                <a href="tel:+5511999999999" className="flex items-center space-x-2 text-orange-600 font-medium">
                  <Phone className="h-5 w-5" />
      ...
      <section id="inicio" className="relative bg-gradient-to-r from-orange-600 to-orange-700 text-white">
        <div className="absolute inset-0">
          <img 
            src="https://images.pexels.com/photos/162539/architecture-building-construction-work-162539.jpeg"
            alt="Construção"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Por Que Escolher a ConstructMax?</h2>
            <p className="text-xl text-gray-600">Mais de 15 anos no mercado oferecendo qualidade e confiança</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
              ...
              <p className="text-gray-600">Entregamos em toda a região metropolitana em até 24h. Frete grátis para compras acima de R$ 500.</p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-6 italic">
                "Excelente atendimento e produtos de qualidade. Reformei toda minha casa com materiais da ConstructMax. Recomendo!"
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-6 italic">
                "Preços justos e entrega rápida. A equipe é muito profissional e sempre me ajuda a encontrar o que preciso."
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">contato@constructmax.com.br</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Rua das Construções, 123<br />Centro - São Paulo/SP</p>
                  </div>
                </div>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="#" className="hover:text-orange-600 transition-colors">Pós-venda</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-700 pt-8 mt-8 text-center text-gray-300">
            <p>&copy; 2025 ConstructMax. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
